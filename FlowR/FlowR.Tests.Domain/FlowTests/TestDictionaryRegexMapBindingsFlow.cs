...
namespace FlowR.Tests.Domain.FlowTests
{
    ...
    public class TestDictionaryRegexMapBindingsFlow : FlowHandler<TestDictionaryRegexMapBindingsRequest, TestDictionaryRegexMapBindingsResponse>
    {
        ...
        protected override void ConfigureDefinition(FlowDefinition<TestDictionaryRegexMapBindingsRequest, TestDictionaryRegexMapBindingsResponse> flowDefinition)
        {
            flowDefinition
                .Do("MapValues", 
